...
abstract class SqlFactoryBaglanti
{
    ...
    protected $baglanti;
    abstract public function setBaglanti();
...
class MysqliBaglanti extends SqlFactoryBaglanti
{
    ...
    {
        $this->baglanti = new mysqli("localhost", "root", "9637414nm", "sinav");
...
abstract class SqlFactorySorgu
{
    ...
    abstract public function setSorgu($sorguMetni, $baglanti);
...
abstract class SqlFactoryExecSorgu
{
    ...
    abstract public function exec_Sorgu1($sorgu);
    abstract public function exec_Sorgu2($sorgu, $a_params);
...
abstract class SqlFactoryFetchData
{
    ...
    abstract public function fetchData($veritabaniData);
