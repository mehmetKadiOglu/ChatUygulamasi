...
class MongoDbGiris extends MongoDbGirisTemplate
{
    ...
    public function jsonHazirla()
    {
        ...
        if ($this->getSonucDiziEleman("dataSayi")) {
            ...
            $_SESSION['kullanici']->setKullaniciAd($this->getSonucDiziEleman("data")[1]["kullaniciAd"]);
            $_SESSION['kullanici']->setKullaniciSoyAd($this->getSonucDiziEleman("data")[1]["kullaniciSoyAd"]);
...
class MongoDbKonuAc extends MongoDbKonuAcTemplate
{
    ...
    public function jsonHazirla()
    {
        ...
        if (is_object($this->getSonucDiziEleman("key"))) {
            ...
            $this->setSonucDiziAjaxEleman("ozelOda", $_POST['ozelOda']);
